...
snakeHeadImage.src = "pics/head.png";
snakeBodyImage = new Image();
snakeBodyImage.src = "pics/body.png";
snakeTailImage = new Image();
snakeTailImage.src = "pics/tail.png";

//food
foodImage = new Image();
foodImage.src = "pics/food.png";
...
function animate()
{
	...
	{
		displayText("You so Bad.. Game Over homie");
	}
...
function mouseClick(e)
{
	...
	xDiff = snake[0].xx - e.x;
	yDiff = snake[0].yy - e.y;


	//click to left or right of head was closer then click above or below head
	if(xDiff > yDiff)
	{
		//if head moving right
		if(e.x > snake[0].xx * 32)
		{
			if(dir != "left")
			{
				dir = "right";
	...
	else //click above or below head was closer then click to left or right of head
	{
		//if head up
		if(e.y > snake[0].yy * 32)
		{
...
//figure out where to move snake
...
function create_food()
{
	...
	do
	{
		...
		//make sure food dont get created on the snake itself.
